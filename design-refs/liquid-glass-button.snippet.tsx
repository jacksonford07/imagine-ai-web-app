// REFERENCE SNIPPET — provided by Jackson (21st.dev origin) for the CEO dash reskin.
// NOT compiled (folder excluded from tsconfig). Target: src/components/ui/liquid-glass-button.tsx
//
// WARNING: contains Tailwind v4-only classes that MUST be converted to v3 before use:
//   - `bg-linear-to-t`            -> `bg-gradient-to-t`
//   - `inset-shadow-2xs`, `dark:inset-shadow-white/10` -> v3 arbitrary inset shadows, e.g.
//     `shadow-[inset_0_1px_rgba(255,255,255,0.10)]` (compose manually; v3 has no inset-shadow-* utilities)
//   - audit every class against Tailwind v3.4 — v4-only syntax silently emits no CSS here.
// Also note: the original export line referenced `liquidbuttonVariants`/`LiquidButton` before
// declaration; keep exports at the bottom in the real component.
// Deps: @radix-ui/react-slot, class-variance-authority (check package.json before adding).
